...
mod_apt_config_install () {
	...
	util_error_echo "sudo install -Dm644 ${THE_OVERLAY_DIR_PATH}/etc/apt/sources.list.d/ubuntusway.list /etc/apt/sources.list.d/ubuntusway.list"
	sudo install -Dm644 "${THE_OVERLAY_DIR_PATH}/etc/apt/sources.list.d/ubuntusway.list" "/etc/apt/sources.list.d/ubuntusway.list"
